...
- [ChatGPT Research Workflow](docs/chatgpt_research_workflow.md) - Quickstart for connecting and validating locally
- [Agent System Overview](docs/agent_system_overview.md) - Summary of modules and agent roles
