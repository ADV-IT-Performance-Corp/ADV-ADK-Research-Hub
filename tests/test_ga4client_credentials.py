...
from o3research.analytics import GA4Client
...
class TestGA4ClientCredentials(unittest.TestCase):
    ...
    def test_refresh_existing_token(self, mock_exists, mock_from_file, mock_write):
        ...
        with patch("o3research.analytics.Request"):
    ...
    def test_run_local_server_new_token(
        self, mock_exists, mock_from_file, mock_flow, mock_write
    ):
        flow = MagicMock()
...
class TestGA4ClientFetchMetrics(unittest.TestCase):
    ...
    def test_no_rows_returns_empty(self):
        ...
        with patch.object(
            GA4Client, "service", new_callable=PropertyMock
        ) as mock_service:
