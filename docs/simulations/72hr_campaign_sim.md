...
| Day 2 22:40 | AnalyticsAgent lost connection | GovernanceAgent issues heartbeat check; fallback metrics used |
...
```text
2025-05-21T04:30Z GovernanceAgent quota throttle activated
...
2025-05-22T22:40Z GovernanceAgent heartbeat check issued after AnalyticsAgent disconnect
...
For integration steps see [Integration Guide](../integration_guide_o3.md).
