# Integration Guide for O3 Deep Research (v3.5.8)

This guide explains how to use this repository as the external knowledge context for the O3 Deep Research prompt (v3.5.8 and above).
...
* `prompt/prompt_kernel_v3.5.md` — Complete v3.5.8 Unified Final prompt
