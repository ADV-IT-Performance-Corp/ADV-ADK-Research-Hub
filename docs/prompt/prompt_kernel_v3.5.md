...
Use this GitHub repository as your structured source of truth: `https://github.com/ADV-IT-Performance-Corp/ADV-ADK-Research-Hub/`
...
```json
{
  ...
  "registry_id": "O3_prompt_kernel_3.5.9"
}
```
